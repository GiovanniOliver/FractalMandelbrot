...
public class Mandelbrot {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Timeamos e iniciamos la generacion del Fractal de forma paralela
        ...
        TimerFrame(startime,endtime,startimeS,endtimeS);
    }
    ...
    private static void TimerFrame(long ST,long SE,long SST,long SSE){
        //Fuente de Letra
        ...
        Time.append("Tiempo en Secuencial: "+(SSE-SST)+"ms\n");//Tiempo en Secuencial
        Time.append("Eficiencia: "+(SSE-SST)/(SE-ST)+"%\n");//Eficiencia
        ...
        System.out.println("Tiempo Serial: "+(SSE-SST)+"ms\n");
    }
    ...
    private static void SerialMandel(){
        ...
        //Titulo de Jframe
        frameS = new JFrame("Conjunto de Mandelbrot en Secuencial");
        //Añadimos la imagen a través del label
        frameS.add(label);
        frameS.pack();
        frameS.setVisible(true);
        frameS.setExtendedState(frame.getExtendedState() | JFrame.MAXIMIZED_BOTH);
